...
import ProvidersHeaders from './components/ProviderHeader/ProvidersHeader';
            ...
            <Box className='ProvidersPage'>
                ...
                <Box className='box-title-categories'>
                    ...
                    <Typography variant='p' sx={{
                        ...
                        {/* {props.nameCategory} */}
                        Encontrá desde productos cosméticos y 
                        de cuidado personal natural, servicios de salud, 
                        hasta terapias holísticas y más.
                    </Typography>
                </Box>
                <Box sx={{
